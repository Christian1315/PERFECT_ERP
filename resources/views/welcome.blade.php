            ...
            <div class="col-md-12">
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        <a class="navbar-brand text-white bg-success btn roundered px-3" href="/"> <strong>ERP FINANFA</strong></a>
    ...
    <div class="container content">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="title">Soyez les bienvenu sur l'API de l'ERP FINANFA</h1>
