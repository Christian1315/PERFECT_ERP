...
class LOGISTIQUE_HELPER extends BASE_HELPER
{
    ...
    static function createLogistique($request)
    {
        ...
        #=====~~ENVOIE D'SMS =======~####
        $message = "Vous avez été ajouté.e à l'ERP FINANFA entant qu'une logistique sur ERP_FINANFA. Veuillez contacter l'administrateur pour avoir les détails de votre compte";
        ...
        try {
            ...
            Send_Notification(
                $user,
                "AJOUTE.e ENTANT QUE LOGISTIQUE SUR ERP FINANFA",
                $message
            );
        } catch (\Throwable $th) {
            //throw $th;
